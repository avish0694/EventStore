...
namespace EventStore.TestClient.Commands
{
    internal class PingFloodProcessor : ICmdProcessor
    {
        ...
        private void PingFlood(CommandProcessorContext context, int clientsCnt, long requestsCnt)
        {
            ...
            context.Log.Info("{@all} requests completed in {@elapsedMilliseconds}ms ({2:0.00} reqs per sec).", all, sw.ElapsedMilliseconds, reqPerSec); /*TODO: structured-log @shaan1337: the following parameters need attention: {2:0.00}*/
