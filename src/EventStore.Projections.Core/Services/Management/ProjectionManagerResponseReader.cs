...
namespace EventStore.Projections.Core.Services.Management
{
                                                   ...
                                                   IHandle<ProjectionManagementMessage.Internal.ReadTimeout>
    {
        ...
        private void ReadForward()
        {
            ...
            _cancellationScope.Register(
                _ioDispatcher.ReadForward(
                    ...
                    () => {
                        Log.Warn("Read forward of stream {@ProjectionNamesBuilder._projectionsMasterStream} timed out. Retrying", ProjectionNamesBuilder._projectionsMasterStream);
                        ReadForward();
                    },
                    _correlationId)
            );
        ...
        private void ReadForwardCompleted(ClientMessage.ReadStreamEventsForwardCompleted completed)
        {
            ...
            {
                Log.Error("Failed reading stream {@ProjectionNamesBuilder._projectionsMasterStream}. Read result: {@completed.Result}, Error: '{@completed.Error}'", ProjectionNamesBuilder._projectionsMasterStream, completed.Result, completed.Error);
                ReadForward();
            }
        }
        ...
        public void Handle(ProjectionManagementMessage.Internal.ReadTimeout timeout)
        {
            ...
            Log.Debug("Read forward of stream {@ProjectionNamesBuilder._projectionsMasterStream} timed out. Retrying", ProjectionNamesBuilder._projectionsMasterStream);
            ReadForward();
        }
        ...
        private void PublishCommand(ResolvedEvent resolvedEvent)
        {
            ...
            {
                Log.Debug("PROJECTIONS: Response received: {@resolvedEvent.OriginalEventNumber}@{@command}", resolvedEvent.OriginalEventNumber, command);
            }
            switch (command)
            {
