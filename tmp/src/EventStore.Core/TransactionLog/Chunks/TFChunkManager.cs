...
namespace EventStore.Core.TransactionLog.Chunks
{
    public class TFChunkManager: IDisposable
    {
        ...
        public TFChunk.TFChunk SwitchChunk(TFChunk.TFChunk chunk, bool verifyHash, bool removeChunksWithGreaterNumbers)
        {
            ...
            Log.Info("Switching chunk #{@chunkHeader.ChunkStartNumber}-{@chunkHeader.ChunkEndNumber} ({@Path.GetFileName(oldFileName})...", chunkHeader.ChunkStartNumber, chunkHeader.ChunkEndNumber, Path.GetFileName(oldFileName));
            ...
            else
            {
                ...
                Log.Info("File {@Path.GetFileName(oldFileName} will be moved to file {@Path.GetFileName(newFileName}", Path.GetFileName(oldFileName), Path.GetFileName(newFileName));
